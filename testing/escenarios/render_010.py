#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Render Escenario PRISM 010 (Neurodatos) — modelo v.1 (prototipo iterativo).
YAML canonico v1.0 estricto -> HTML dinamico.
Mejoras v.1: nav de capitulos fijo (sticky), narrativa con imagen,
fundamentos con cita-link por item, caps condensados en cuadros.
"""
import yaml, html, re, pathlib, urllib.parse

ROOT = pathlib.Path(__file__).resolve().parent
YAML_PATH = ROOT / "PRISM-2026-010-neurodatos-soberania-digital.yaml"
OUT = ROOT / "PRISM-2026-010-neurodatos-soberania-digital.html"
ASSETS = "assets"
...
imp_fig = f'<figure class="fig reveal"><img loading="lazy" src="{ASSETS}/neurodata-trust.png" alt="Neuro-Data Trust"><figcaption>Neuro-Data Trust: el cerebro como territorio soberano.</figcaption></figure>'
imp_html = ""
for k in imp_order:
    v = imp.get(k)
    if not v: continue
...
f=e.get("fundamentos",{})
fund_html=""
fund_fig=f'<figure class="fig reveal"><img loading="lazy" src="{ASSETS}/bci-interface.png" alt="BCI"><figcaption>BCI: la frontera mente-maquina.</figcaption></figure>'
...
{chapnav}
<div class="hero"><img src="{ASSETS}/hero-brain-soberania.png" alt="Neurodatos como soberania digital">
<div class="container">
...
<figure class="narr-fig reveal"><img loading="lazy" src="{ASSETS}/bci-interface.png" alt="Frontera neurotecnologica"><figcaption>La frontera mente-maquina: interfaces cerebro-computadora de consumo.</figcaption></figure></section>
